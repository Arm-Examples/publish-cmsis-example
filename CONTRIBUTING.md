...
- Raise an issue found via [GitHub Issues](https://github.com/Arm-Examples/publish-cmsis-example/issues).
- Open an [pull request](https://github.com/Arm-Examples/publish-cmsis-example/pulls) to:
  - Provide a fix.
